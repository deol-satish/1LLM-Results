...
for llm_tag in llm_tags:
    ...
    all_traffic_original_logs = load_log_files(log_dir,"original",llmfreq,"all_traffic")
    all_traffic_llm_logs = load_log_files(log_dir,"llm",llmfreq,"all_traffic")
    ...
    print("----------------------------------------------")
    print("Extracting data from original logs all_traffic_extract_data")
    # Extract from original logs
    steps_all_traffic_original, queue_delays_all_traffic_original, packet_lengths_all_traffic_original, losses_all_traffic_original = extract_data(all_traffic_original_logs)
    print("----------------------------------------------")
    print("Extracting data from LLM-enhanced logs all_traffic_extract_data")
    # Extract from LLM-enhanced logs
    steps_all_traffic_llm, queue_delays_all_traffic_llm, packet_lengths_all_traffic_llm, losses_all_traffic_llm = extract_data(all_traffic_llm_logs)
    ...
    print("==="*10)
    print("All Traffic Queue ")

    df, cdf_df = create_dataframe(steps_all_traffic_original, queue_delays_all_traffic_original, packet_lengths_all_traffic_original, losses_all_traffic_original,
                            steps_all_traffic_llm, queue_delays_all_traffic_llm, packet_lengths_all_traffic_llm, losses_all_traffic_llm)
    
    eval_tag = f"{llm_tag}_eval_{llmfreq}_freq_all_traffic"
